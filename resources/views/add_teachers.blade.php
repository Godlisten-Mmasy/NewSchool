...
@section('title','Add Teachers | SCHOOL MANAGEMENT SYSTEM(SMS)')
...
<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			@endif
				...
				<form class="inner-form" action="{{route('add_mgteachers_submit')}}" method="post">
					@csrf
					<div>
					...
					<div>
						...
						<input class="form-control" type="text" name="tname" value="" placeholder="Surname" required>
					</div>
					<div>
